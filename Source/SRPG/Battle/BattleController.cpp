...
void ABattleController::SetupInputComponent()
{
	...
	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ABattleController::OnResetVR);
}

void ABattleController::OnResetVR()
{
...
void ABattleController::MoveToMouseCursor()
{
	...
	{
		if (ASRPGCharacter* MyPawn = Cast<ASRPGCharacter>(GetPawn()))
		{
